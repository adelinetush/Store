...
<html>
	...
	<body>
		...
		<div>
			...
			<g:hasErrors bean="${regionsInstance}">
                            <div class="alert alert-danger" role="alert">
                                <ul>
                                    <g:eachError bean="${regionsInstance}" var="error">
                                    <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                                    </g:eachError>
                                </ul>
                            </div>
			</g:hasErrors>
			<g:form class="form-horizontal" url="[resource:regionsInstance, action:'update']" method="PUT" >
                            <fieldset>
                               <g:hiddenField name="version" value="${regionsInstance?.version}" />
